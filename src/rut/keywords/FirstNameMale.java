...
public class FirstNameMale extends Keyword {

	public FirstNameMale(MemoryStorage memory) {
		super(memory, "FirstNameMale");

	}

	/**
	 * Creates a random male English first name. If the parameter 'unique' is passed,
	 ...
	 * across the database 
	 * @return a string that is a random male English first name
	 */
	...
	public String generate(String parameter) {
		...
		HashSet<String> nameSet = new HashSet<String>(Randomizer.firstNamesMaleEnglish);
